...
<head>
    ...
    <meta name="description" content="Identificación Animal - MDC">
    <meta name="keywords" content="mascotas, carnet, Identificación Animal">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-primary shadow-sm">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}">
                    <img src="{{ asset('img/logo.png') }}" alt="Logo Muni Castilla" style="width: 150px">
                </a>
